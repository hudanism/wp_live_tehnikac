...
class ARPlite_PricingTable {
	...
	function arplite_front_inline_css_callback( $template_id, $tbl_preview = 0 ){
	...
	function arplite_enqueue_inline_editor_css() {
		...
		if( isset($_GET['page']) && 'arpricelite' == $_GET['page'] && isset($_GET['arp_action']) && '' != $_GET['arp_action'] ){
			...
			foreach ($font_array as $key => $font_values) {
			    ...
			    wp_enqueue_style( 'arplite-editor-google-fonts1', $google_font_url_one, array(), $arpricelite_version );
			    wp_enqueue_style( 'arplite-editor-google-fonts2', $google_font_url_two, array(), $arpricelite_version );
			}
	            	...
	            	if ($columns['ribbon_setting']['arp_ribbon'] != 'arp_ribbon_6') {
	                    if (in_array($base_color, $basic_col)) {
	                        ...
	                        if ($columns['ribbon_setting']['arp_ribbon'] == 'arp_ribbon_3') {
	                            ...
	                            $template_css .= ".arplite_price_table_" . $template_name . " #main_" . $j . " .arp_ribbon_content{";
