                            ...
                            $tablestring .= "<div class='column_content_light_row column_opt_row' style='border-bottom: none;'>";
                                ...
                                $tablestring .= "<div class='column_opt_opts arp_font_family'>";
                                    ...
                                    $tablestring .= "<div class='font_title_font_family_div'>";
                                        ...
                                        $tablestring .= "<input type='hidden' id='tooltip_font_family' class='arp_custom_font_family_options' name='tooltip_font_family' value='' data-default-font='' />";
                                        ...
                                        $tablestring .= "<div class='arp_google_font_preview_note' style=''><a target='_blank'  class='arp_google_font_preview_link' id='arp_tooltip_font_family_preview' href='" . $googlefontpreviewurl . $general_option['column_settings']['button_font_family_global'] . "'>" . esc_html__('Font Preview', 'arprice-responsive-pricing-table') . "</a></div>";
                            ...
                            $tablestring .= "<div class='column_content_light_row column_opt_row' style='border-bottom: none;'>";
                                ...
                                $tablestring .= "<div class='column_opt_opts arp_font_family'>";
                                    ...
                                    $tablestring .= "<div class='font_title_font_family_div'>";
                                        ...
                                        $tablestring .= "<div class='arp_google_font_preview_note'><a target='_blank'  class='arp_google_font_preview_link' id='arp_toggle_title_font_family_preview' href='". $googlefontpreviewurl . $general_option['column_settings']['button_font_family_global'] . "'>" . esc_html__('Font Preview', 'arprice-responsive-pricing-table') . "</a></div>";
                            ...
                            $tablestring .= "<div class='column_content_light_row column_opt_row arp_no_border' style='border-bottom: none;'>";
                                ...
                                $tablestring .= "<div class='column_opt_opts arp_font_family'>";
                                    ...
                                    $tablestring .= "<div class='font_title_font_family_div'>";
                                        ...
                                        $tablestring .= "<div class='arp_google_font_preview_note'><a target='_blank'  class='arp_google_font_preview_link' id='arp_toggle_button_font_family_preview' href='". $googlefontpreviewurl . $general_option['column_settings']['button_font_family_global'] . "'>" . esc_html__('Font Preview', 'arprice-responsive-pricing-table') . "</a></div>";
                    ...
                    $tablestring .= "<div class='btn-main rpt'>";
                        ...
                        $tablestring .= "<div class='column_level_button_wrapper'>";
                            ...
                            $tablestring .= "<div class='arp_btn action_btn' col-id=" . $col_no[1] . " data-level='column_level_options' id='delete_column' style='display:none;' title='" . esc_html__('Delete Column', 'arprice-responsive-pricing-table') . "' data-title='" . esc_html__('Delete Column', 'arprice-responsive-pricing-table') . "'>";
                                ...
                                $tablestring .= "<button col-id='" . $col_no[1] . "' type='button' class='ribbon_insert_btn arp_delete_column_btn delete_column'>" . esc_html__('Ok', 'arprice-responsive-pricing-table') . "</button>";
                                $tablestring .= "<button col-id='" . $col_no[1] . "' type='button' class='ribbon_cancel_btn arp_cancel_delete_column_btn'>" . esc_html__('Cancel', 'arprice-responsive-pricing-table') . "</button>";
                                $tablestring .= "</div>";
                                $tablestring .= "</div>";
