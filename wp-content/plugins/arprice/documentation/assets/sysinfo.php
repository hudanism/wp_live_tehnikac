...
if ( is_plugin_active( 'arprice/arprice.php' ) ) 
{
...
$arprice_active_text = "";
$arprice_license_details = "";
$arprice_active_text = "<font color='#10bd0d'>".$arprice_active."</font>";
$arprice_active = $arprice_active_text;
...
<tr>
	<td colspan="2" class="title">ARPrice Details &nbsp; <?php echo $arprice_license_details; ?></td>
</tr>
<tr>
	<td class="leftrowtitle">Variable Name</td>
    <td class="rightrowtitle">Details</td>
...
<tr>
	<td class="leftrowdetails">ARPrice Status</td>
    <td class="rightrowdetails"><?php echo $arprice_active;?></td>
</tr>
<tr>
	<td class="leftrowdetails">ARPrice Version</td>
